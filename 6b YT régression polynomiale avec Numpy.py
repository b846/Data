...
# -*- coding: utf-8 -*-
"""
Created on Thu Feb 20 14:01:44 2020

@author: b
Pour complexifier notre modèle précédent, on va utiliser Y non linéaire
et on va ajouter une colonne x² à X
"""
...
x, y = make_regression(n_samples=100, n_features=1, noise=10) #n_features est important
y = y + abs(y)
